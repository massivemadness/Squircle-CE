...
internal interface ChangelogComponent {
    ...
    @Component.Factory
    interface Factory {
        fun create(coreApiDepsProvider: CoreApiDepsProvider): ChangelogComponent
    }

    companion object {

        private var component: ChangelogComponent? = null

        fun buildOrGet(context: Context): ChangelogComponent {
            return component ?: DaggerChangelogComponent.factory().create(
