...
KEYWORD_OTHER1 = abstract type|mutable struct|primitive type
...
<YYINITIAL> {
  ...
  {SYMB_OP} { return JuliaToken.SYMB_OP; }
  {SYMB_LANG} { return JuliaToken.SYMB_LANG; }
  ...
  {SYMB_OP_ASCII} { return JuliaToken.SYMB_OP_ASCII; }
  {SYMB_ID} { return JuliaToken.SYMB_ID; }

  {LONG_OP} { return JuliaToken.LONG_OP; }
