...
package com.blacksquircle.ui.feature.servers.ui.list.compose
...
private fun ConnectionStatusPreview() {
    PreviewBackground {
        Column(
            ...
            ConnectionStatus(ServerStatus.Checking)
            ConnectionStatus(ServerStatus.Unavailable("Failed to authenticate"))
            ConnectionStatus(ServerStatus.Available(200L))
        }
    }
}