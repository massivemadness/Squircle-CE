...
package com.blacksquircle.ui.feature.servers.ui.details.compose
    ...
    Row(modifier) {
        ...
        TextField(
            ...
            placeholderText = when (scheme) {
                ServerType.FTP,
                ServerType.FTPS,
                ServerType.FTPES -> ServerDetailsViewState.DEFAULT_FTP_PORT.toString()
                ServerType.SFTP -> ServerDetailsViewState.DEFAULT_SFTP_PORT.toString()
            },
            keyboardOptions = KeyboardOptions(
