...
public class ChangeLogDialogPreference extends DialogPreference {
    ...
    public ChangeLogDialogPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    public ChangeLogDialogPreference(Context context, AttributeSet attrs, int defStyleAttr) {
