...
public class ToggleWidgetFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_toggle_widget_display, container, false);
        showCode(view);
        return view;
    }
    ...
    public void showCode(View view) {
        ...
        try {
            ...
            InputStream in_s = res.openRawResource(R.raw.toggle_widget);
