...
public class SwitchWidgetFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_switch_widget_display, container, false);
        showCode(view);
        return view;
    }
    ...
    public void showCode(View view) {
        ...
        try {
            ...
            InputStream in_s = res.openRawResource(R.raw.switch_widget);
