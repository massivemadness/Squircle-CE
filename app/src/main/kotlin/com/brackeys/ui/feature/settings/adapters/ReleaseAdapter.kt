...
package com.brackeys.ui.feature.settings.adapters
...
import com.brackeys.ui.databinding.ItemReleaseBinding
...
class ReleaseAdapter : ListAdapter<ReleaseModel, ReleaseAdapter.ReleaseViewHolder>(diffCallback) {
    ...
    class ReleaseViewHolder(
    ...
    ) : BaseViewHolder<ReleaseModel>(binding.root) {
        ...
        override fun bind(item: ReleaseModel) {
            releaseModel = item
