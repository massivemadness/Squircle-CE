...
public class HeaderApplication extends PreferenceFragment {

    @Override
    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        addPreferencesFromResource(R.xml.header_application);

        Preference mShopPreference = findPreference("THEME_RESOURCE");
