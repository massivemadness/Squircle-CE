...
object ColorSchemeConverter {
    ...
    fun toSyntaxScheme(colorScheme: ColorScheme): SyntaxScheme {
        return SyntaxScheme(
            numberColor = colorScheme.numberColor,
            operatorColor = colorScheme.operatorColor,
            keywordColor = colorScheme.keywordColor,
            typeColor = colorScheme.typeColor,
            langConstColor = colorScheme.langConstColor,
