    ...
    val MIGRATION_2_3 = object : Migration(2, 3) {
        override fun migrate(database: SupportSQLiteDatabase) {
            ...
            database.execSQL("""
                ...
                ('3f2f13b0-475f-4b4b-9da3-e4f5e2b5959f','Monokai','Light Team Software','Default color scheme.',0,1,'#F8F8F8','#272823','#272823','#5B5A4F','#C8BBAC','#5B5A4F','#34352D','#666666','#7CE0F3','#5F5E5A','#5F5E5A','#BB8FF8','#F8F8F2','#E8E2B7','#EB347E','#EB347E','#EB347E','#B6E951','#EBE48C','#89826D'),
