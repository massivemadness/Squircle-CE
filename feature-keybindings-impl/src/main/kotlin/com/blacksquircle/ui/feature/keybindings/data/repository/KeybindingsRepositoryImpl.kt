...
package com.blacksquircle.ui.feature.keybindings.data.repository
...
class KeybindingsRepositoryImpl(
    private val dispatcherProvider: DispatcherProvider,
    private val settingsManager: SettingsManager,
) : KeybindingsRepository {

    override suspend fun loadKeybindings(): List<KeybindingModel> {
        return withContext(dispatcherProvider.io()) {
            Keybinding.values().map { keybinding ->
                KeybindingModel(
