...
class SettingsTest {
    ...
    @Test
    fun `When back pressed with confirmation disabled Then send popBackStack event`() = runTest {
        // Given
        val viewModel = createViewModel()
        every { settingsManager.confirmExit } returns false
    ...
    @Test
    fun `When back pressed with confirmation enabled Then open confirmation dialog`() = runTest {
        // Given
        val viewModel = createViewModel()
    ...
    @Test
    fun `When settings clicked Then open settings screen`() = runTest {
        // Given
        val viewModel = createViewModel()
