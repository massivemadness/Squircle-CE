...
internal data class HeaderListViewState(
    val headers: List<PreferenceHeader> = listOf(
        ...
        PreferenceHeader(
            title = R.string.settings_header_editor_title,
            subtitle = R.string.settings_header_editor_subtitle,
            selected = false,
            screen = EditorHeaderScreen,
        ),
        PreferenceHeader(
            title = R.string.settings_header_codestyle_title,
            subtitle = R.string.settings_header_codestyle_subtitle,
            selected = false,
            screen = CodeStyleHeaderScreen,
        ),
        PreferenceHeader(
            title = R.string.settings_header_files_title,
            subtitle = R.string.settings_header_files_subtitle,
            selected = false,
            screen = FilesHeaderScreen,
        ),
        PreferenceHeader(
            title = R.string.settings_header_keybindings_title,
            subtitle = R.string.settings_header_keybindings_subtitle,
            selected = false,
            screen = ShortcutsScreen,
        ),
        PreferenceHeader(
            title = R.string.settings_header_cloud_title,
            subtitle = R.string.settings_header_cloud_subtitle,
            selected = false,
            screen = CloudScreen,
        ),
        PreferenceHeader(
            title = R.string.settings_header_git_title,
            subtitle = R.string.settings_header_git_subtitle,
            selected = false,
            screen = GitHeaderScreen,
        ),
        PreferenceHeader(
            title = R.string.settings_header_about_title,
            subtitle = R.string.settings_header_about_subtitle,
            selected = false,
